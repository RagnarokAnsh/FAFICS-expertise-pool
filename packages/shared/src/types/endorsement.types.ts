...
/**
 * Read-only view of an application shown to the president via magic link.
 * Does NOT include presidentNotes, secretaryNotes, or internal IDs beyond referenceNumber.
 */
