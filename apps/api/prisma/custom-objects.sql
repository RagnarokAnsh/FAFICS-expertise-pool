-- =============================================================================
-- FAFICS Expertise Pool — Custom PostgreSQL Objects (post-Prisma migration)
-- Applied after `prisma migrate dev` to add functions, triggers, views,
-- and indexes that Prisma cannot generate.
-- =============================================================================
