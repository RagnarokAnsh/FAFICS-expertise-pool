...
export function expiredTemplate(params: {
  ...
  const body = `
    ...
    <p>Your information is no longer active in the roster. If you would like to be considered for the pool again, you can submit a new application at any time.</p>
