...
- `ApplicationExpertise` uses a **partial unique index** (in raw SQL, not Prisma) for the 11 fixed expertise areas. Custom ("Other") rows use `isCustom = true` and are always inserted, never upserted.
